            ...
            <form className="Auth-form" onSubmit={submit}>
                <div className="Auth-form-content">
                    ...
                    <div className="form-group mt-3">
                        ...
                        <input name='password' type="password" className="form-control mt-1"placeholder="Enter password"value={password}required onChange={e => setPassword(e.target.value)}/>
                    </div>
